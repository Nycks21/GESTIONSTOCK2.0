...
public class GetAccuse : IHttpHandler, IRequiresSessionState
{
  public void ProcessRequest(HttpContext ctx)
  {
    ...
    try
    {
      ...
      // ✅ Whitelist élargie : ajout de DESTINATION et BENEFICIAIRE
      var allowedSort = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
    { "DATE_SORTIE", "DATE_RECEPTION", "NUMERO", "NOM", "BENEFICIAIRE", "DESTINATION", "STATUT" };
    ...
    { "ASC", "DESC" };
      ...
      // ✅ Mapping du nom "public" vers la vraie colonne SQL
      string orderColumn;
