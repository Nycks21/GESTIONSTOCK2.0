        ...
        <div class="content-wrapper" id="contentWrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <h1><i class="fas fa-truck" style="color:#dc3545;"></i> Bons de sortie</h1>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="dash-card">
                    ...
                    <div class="dash-card-toolbar">
                        ...
                        <select id="statut-filter" class="form-control toolbar-select">
                            ...
                            <option value="TERMINE">Reçu</option>
                        </select>
                        ...
                        <button class="btn-modern btn-ghost" id="btnResetFilters" onclick="resetFilters()" type="button" title="Réinitialiser les filtres">
                            ...
                            <table class="dash-table"
                                ...
                                <thead>
                                    <tr style="background-color:#f8f9fa; text-align:left;">
                                        ...
                                        <th onclick="sortData('DATE_SORTIE')" style="cursor:pointer; width:90px;">Date sortie <i class="fas fa-sort ml-1"></i></th>
                                        <th onclick="sortData('DATE_RECEPTION')" style="cursor:pointer; width:90px;">Date réception <i class="fas fa-sort ml-1"></i></th>
                                        <th style="width:180px;">Articles</th>
                                        <th style="width:110px; text-align:right;">Qté reçue</th>
                                        <th onclick="sortData('NOM')" style="cursor:pointer; width:180px;">Bénéficiaire <i class="fas fa-sort ml-1"></i></th>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Numéro <small class="text-muted">(généré automatiquement)</small></label>
                    ...
                    <table class="table table-bordered table-sm" id="lignesTable" style="margin-bottom:0;">
                        <thead style="background:#f1f1f1; position:sticky; top:0; z-index:1;">
                            <tr>
                                ...
                                <th style="width:50px;">
                                    <button type="button" class="btn-icon btn-success" onclick="ajouterLigne()" title="Ajouter une ligne">
