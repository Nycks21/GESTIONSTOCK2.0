                                ...
                                <table class="dash-table" style="table-layout:fixed; width:1300px; min-width:100%; border-collapse:collapse;">
                                    <thead>
                                        <tr style="background-color:#f8f9fa; text-align:left;">
                                            ...
                                            <th onclick="sortData('DESTINATION')" style="cursor:pointer; width:150px;">Destination <i class="fas fa-sort ml-1"></i></th>
                                            <th onclick="sortData('NOM')" style="cursor:pointer; width:120px;">Bénéficiaire <i class="fas fa-sort ml-1"></i></th>
                                            <th onclick="sortData('FONCTION')" style="cursor:pointer; width:100px;">Fonction <i class="fas fa-sort ml-1"></i></th>
                                            <th onclick="sortData('STATUT')" style="cursor:pointer; width:100px;">Statut <i class="fas fa-sort ml-1"></i></th>
                                            <th onclick="sortData('CREATED_AT')" style="cursor:pointer; width:130px;">Créé le <i class="fas fa-sort ml-1"></i></th>
