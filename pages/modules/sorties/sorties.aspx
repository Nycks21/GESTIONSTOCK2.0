                ...
                <div class="dash-card">
                  <div class="dash-card-head">
                    ...
                    <div class="action-buttons">
                      ...
                      <button class="btn-modern btn-outline-success" onclick="openImportModal(event)" type="button"
                        disabled>
                        ...
                        <thead>
                          <tr style="background-color:#f8f9fa; text-align:left;">
                            ...
                            <th onclick="sortData('DATE_SORTIE')" style="cursor:pointer; width:90px;">Date sortie <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('DATE_RECEPTION')" style="cursor:pointer; width:90px;">Date réception
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" id="sortieDestination" class="form-control" placeholder="Service, atelier…"
                    required>
