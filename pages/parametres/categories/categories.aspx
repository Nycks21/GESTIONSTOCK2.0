                ...
                <div class="dash-card">
                  <div class="dash-card-head">
                    ...
                    <div class="action-buttons">
                      ...
                      <button class="btn btn-outline-success btn-sm" onclick="exportCategoriesToExcelOnly()"
                        type="button">
                        ...
                        <thead>
                          <tr style="background-color:#f8f9fa; text-align:left;">
                            ...
                            <th onclick="sortData('NOM')" style="cursor:pointer; width:200px;">NOM <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('PARENT_NOM')" style="cursor:pointer; width:150px;">CATÉGORIE PARENTE
        ...
        <div class="modal-content modal-categorie" style="max-width:600px;">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" id="categorieCode" class="form-control" placeholder="CAT-XXX-00001" readonly />
