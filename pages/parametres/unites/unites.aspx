                    ...
                    <div class="dash-card">
                        ...
                        <div class="dash-card-body">
                            <div style="overflow-x:auto; width:100%; border:1px solid #dee2e6; border-radius:8px;">
                                <table class="dash-table" style="table-layout:fixed; width:100%; min-width:600px; border-collapse:collapse;">
                                    <thead>
            ...
            <div class="modal-content modal-unite" style="max-width:600px;">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="uniteCode" class="form-control" placeholder="Ex: KG" required />
