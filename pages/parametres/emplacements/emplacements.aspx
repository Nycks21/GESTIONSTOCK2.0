<%@ Page Language="C#" AutoEventWireup="true" CodeFile="emplacement.aspx.cs" Inherits="emplacement" %>
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emplacements — Gestion de Stock</title>
            ...
            <div class="content-wrapper" id="contentWrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1><i class="fas fa-warehouse" style="color:#007bff;"></i> Emplacements</h1>
                            </div>
                            <div class="col-lg-6">
                ...
                <section class="content" id="section-emplacements">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="stat-card stat-card-total">
                                ...
                                <div class="stat-body">
                                    ...
                                    <span class="stat-label">Total emplacements</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="stat-card stat-card-alerte">
                                ...
                                <div class="stat-body">
                                    ...
                                    <span class="stat-label">Sous-emplacements</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dash-card">
                        <div class="dash-card-head">
                            <span class="dash-card-title"><i class="fas fa-warehouse"></i> Liste des emplacements</span>
                        ...
                        <div class="dash-card-toolbar">
                            ...
                            <span class="toolbar-counter" id="resultsCounter">0 emplacement(s)</span>
                        </div>
                                ...
                                <table class="dash-table" style="table-layout:fixed; width:100%; min-width:800px; border-collapse:collapse;">
                                    <thead>
                                        <tr style="background-color:#f8f9fa; text-align:left;">
                                            ...
                                            <th onclick="sortData('NOM')" style="cursor:pointer; width:180px;">NOM <i class="fas fa-sort ml-1"></i></th>
                                            <th onclick="sortData('TYPE')" style="cursor:pointer; width:120px;">TYPE <i class="fas fa-sort ml-1"></i></th>
                                            <th onclick="sortData('PARENT_NOM')" style="cursor:pointer; width:150px;">PARENT <i class="fas fa-sort ml-1"></i></th>
                                            <th onclick="sortData('ACTIVE')" style="cursor:pointer; width:90px;">STATUT <i class="fas fa-sort ml-1"></i></th>
        ...
        <div id="emplacementModal" class="modal">
            ...
            <div class="modal-content modal-emplacement" style="max-width:600px;">
                <div class="modal-header">
                    <h3 id="modalTitle"><i class="fas fa-warehouse"></i> Ajouter un emplacement</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="emplacementCode" class="form-control" placeholder="Ex: ENT-001" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="emplacementNom" class="form-control" placeholder="Nom de l'emplacement" required>
