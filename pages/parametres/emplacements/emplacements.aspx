                ...
                <div class="dash-card">
                  <div class="dash-card-head">
                    ...
                    <div class="action-buttons">
                      ...
                      <button class="btn btn-outline-success btn-sm" onclick="exportEmplacementsToExcelOnly()"
                        type="button">
                        ...
                        <thead>
                          <tr style="background-color:#f8f9fa; text-align:left;">
                            ...
                            <th onclick="sortData('NOM')" style="cursor:pointer; width:180px;">NOM <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('TYPE')" style="cursor:pointer; width:120px;">TYPE <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('PARENT_NOM')" style="cursor:pointer; width:150px;">PARENT <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('ACTIVE')" style="cursor:pointer; width:90px;">STATUT <i
                                class="fas fa-sort ml-1"></i></th>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" id="emplacementCode" class="form-control" placeholder="EMP-XXX-00001" readonly />
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" id="emplacementNom" class="form-control" placeholder="Nom de l'emplacement"
                    required>
