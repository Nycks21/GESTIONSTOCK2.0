...
function showErrorToast(message) { showToast(_t('message.error'), message, 'error'); }
function showSuccessToast(message) { showToast(_t('message.success'), message, 'success'); }
