                ...
                <div class="dash-card">
                  <div class="dash-card-head">
                    ...
                    <div class="action-buttons">
                      ...
                      <button class="btn btn-outline-success btn-sm" onclick="exportFournisseursToExcelOnly()"
                        type="button">
                        ...
                        <thead>
                          <tr style="background-color:#f8f9fa; text-align:left;">
                            ...
                            <th onclick="sortData('NOM')" style="cursor:pointer; width:160px;">NOM <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('ADRESSE')" style="cursor:pointer; width:100px;">ADRESSE <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('TELEPHONE')" style="cursor:pointer; width:100px;">TÉLÉPHONE <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('EMAIL')" style="cursor:pointer; width:120px;">EMAIL <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('CONTACT_NOM')" style="cursor:pointer; width:120px;">STAT <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('SIRET')" style="cursor:pointer; width:100px;">NIF <i
                                class="fas fa-sort ml-1"></i></th>
                            <th onclick="sortData('ACTIVE')" style="cursor:pointer; width:80px;">STATUT <i
                                class="fas fa-sort ml-1"></i></th>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="fournisseurCode" class="form-control" placeholder="FRS-XXX-00001" readonly />
